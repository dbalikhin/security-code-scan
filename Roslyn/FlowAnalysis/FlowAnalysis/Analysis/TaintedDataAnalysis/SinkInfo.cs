...
namespace Analyzer.Utilities.FlowAnalysis.Analysis.TaintedDataAnalysis
{
    ...
    {
        public SinkInfo(string fullTypeName, ImmutableHashSet<SinkKind> sinkKinds, bool isInterface, bool isAnyStringParameterInConstructorASink, ImmutableHashSet<string> sinkProperties, ImmutableHashSet<(MethodMatcher, ImmutableHashSet<string>)> sinkMethodMatchingParameters, ImmutableDictionary<string, ImmutableHashSet<string>> sinkMethodParameters)
        {
